...
class Apilandlrdsontroller extends ActiveController
{
        ...
        if ($method != 'POST') {
            ...
            if (!empty($_POST)){
                ...
                if($model->validate()){
                    ...
                    ])->andWhere(['in','role',['Landlord']])->asArray()->one();
    ...
    public function actionForgotpassword()
    {
        ...
        if ($method != 'POST') {
            ...
            if (!empty($_POST) && !empty($_POST['email'])) {
                $model = Users::find()->where(['email'=>$_POST['email'],'status'=>1])->andWhere(['in','role',['Landlord']])->one();
                if(!empty($model)){
