        ...
        <div class="col-md-8">
            <div class="booking-requests-form box box-primary">
                <div class="box-header with-border">
                    <h4>Upload Milestone Documents - <?php echo $model->property->title;?></h4>
                </div>
                        ...
                        <?php foreach ($modelsAddress as $i => $modelAddress): ?>
                            <div class="item panel panel-default"><!-- widgetBody -->
                                <div class="panel-heading">
                                    <h3 class="panel-title pull-left">Renovation Milestone Document</h3>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <?= $form->field($modelAddress, "[{$i}]document_pdf")->fileInput(['maxlength' => true]) ?>
                                        </div>
