    ...
    <div class="col-md-6">
        ...
        <div class="service-requests-form box box-primary">
            ...
            <div class="box-body table-responsive">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <?= $form->field($model, 'request_to')->radioList(['Tenant' => 'Tenant', 'Landlord' => 'Landlord'])->label('Request To'); ?>

                    </div>
                </div>
                <?php
                $vendors = \app\models\Users::find()->where(['role'=>'Mover','current_status'=>'Free'])->asArray()->all();
                //print_r($properties);exit;
                if(!empty($vendors)){
                ...
                <?= $form->field($model, 'pickup_location')->textarea(['maxlength' => true]) ?>
                <?= $form->field($model, 'dropoff_location')->textarea(['maxlength' => true]) ?>
                <?= $form->field($model, 'truck_size')->dropDownList(['1/2 Ton' => '1/2 Ton','1 Ton'=>'1 Ton','2 Ton'=>'2 Ton','3 Ton'=>'3 Ton']) ?>
